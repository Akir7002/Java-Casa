...
// Arreglos y Matriz    
    ...
    public static void cargarDatosDePrueba(String[] estudiantes, double[][] calificaciones) {
        ...
        // Nombres de prueba
        estudiantes[0] = "Diana Rodriguez";
        estudiantes[1] =  "Camilo Suarez";
        estudiantes[2] = "Nicolas Pardo";
        estudiantes[3] = "Isabela alvarez";
        estudiantes[4] = "Sara Martinez";

        // Calificaciones de prueba [estudiante][materia]
        // Diana: notas malas, reprueba
        calificaciones[0] = new double[]{4.5, 3.6, 2.4, 6.5}; // Promedio: 4.50
        // Camilo: Notas bajas, reprueba
        calificaciones[1] = new double[]{5.0, 6.0, 5.5, 4.0}; // Promedio: 5.125
        // Nicolas: Excelentes notas, aprueba
        calificaciones[2] = new double[]{9.5, 8.8, 10.0, 9.1}; // Promedio: 9.35
        // Isabella: Notas justas, aprueba
        calificaciones[3] = new double[]{6.0, 6.4, 5.7, 6.1}; // Promedio: 6.30
        // Sara: Notas malas, reprueba
    ...
    /**
     * Lee la opción seleccionada por el usuario de una manera segura.
     * @param scanner 
    ...
    public static int leerOpcion(Scanner scanner) {
        ...
        scanner.nextLine(); // Limpiar el buffer después de leer
        return opcion;
    }
    ...
    public static void ingresarCalificaciones(double[][] calificaciones, String[] estudiantes, String[] materias, Scanner scanner) {
        ...
        double nota;
        for (int i = 0; i < estudiantes.length; i++) { //  estudiantes
...
/**
     * Muestra qué estudiantes aprobaron y quiénes reprobaron 
     * @param calificaciones La matriz de calificaciones.
     * @param estudiantes El arreglo de nombres de estudiantes.
    ...
    public static void mostrarEstadisticasGenerales(double[][] calificaciones) {
        ...
        double[] estadisticas = calcularEstadisticas(calificaciones);
    ...
    /**
     * Calcula estadísticas generales: mayor calificación, menor calificación y promedio general.
     * @param calificaciones Matriz de calificaciones.
     * @return Un arreglo con las estadísticas [mínima, máxima, promedio].
     */
    public static double[] calcularEstadisticas(double[][] calificaciones) {
        ...
        for (double[] estudiante : calificaciones) {
            for (double nota : estudiante) {
                sumaTotal += nota;
                totalCalificaciones++;
                if (nota < calificacionMin) calificacionMin = nota;
                if (nota > calificacionMax) calificacionMax = nota;
            }
        }

        double promedioGeneral = (totalCalificaciones > 0) ? sumaTotal / totalCalificaciones : 0.0;
        return new double[]{calificacionMin, calificacionMax, promedioGeneral};
    }
